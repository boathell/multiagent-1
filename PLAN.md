...
- 时间: 2026-03-04 19:35:30 CST
  - 里程碑: README 配置项解释增强
  - 完成内容: 在 `README.md` 的治理章节新增关键配置项解释，明确 `REVIEW_MAX_LOOPS` 与 `REVIEW_ARBITER_MAX_LOOPS` 的用途、触发时机、配合关系与建议值；补充常见误区说明。
  - 证据: `README.md` 新增 `8.1 关键配置项说明` 与 `8.2 两个 Review 阈值如何配合`。
  - 下一步: 如需，可继续补充 `.env.example` 中对应注释，做到配置与文档双向一致。
